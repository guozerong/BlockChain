<template>
    <div>
       ...
       <ul id="first-class">
          <!-- 二级菜单:合同 -->
         <li @click="goto('/enterprise/contract')" class="dropdown" >
             <a>合同管理</a>
         </li>
       <!-- 二级菜单:库存 -->
         <li @click="goto('/enterprise/inventory')" class="dropdown">
            <a>库存管理</a>
         </li>
       <!-- 二级菜单:物流 -->
         <li @click="goto('/enterprise/logistics')" class="dropdown">
           <a>物流管理 </a>  
             </li>
       <!-- 二级菜单:Token -->
            <li class="dropdown">
                ...
                <ul class="dropdown-content">
                 <li @click="goto('/enterprise/tokenpay')">
                    <a>收支Token</a>
                 </li>
                 <li @click="goto('/enterprise/tokenchange')">
                    <a>兑付Token</a>
                 </li>
                
              </ul>
            </li>
        <li @click="goto('/enterprise/insurance')" class="dropdown">
            <a>保单管理</a>
        </li>
...
a {
    ...
    line-height:30px;         /* 设置内边距让文字垂直居中。 */
    color:#000000;            /* 修改文字初始颜色 */
