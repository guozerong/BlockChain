<template>
    <div>
       ...
       <ul id="first-class">
          <!-- 二级菜单:合同 -->
         <li @click="goto('/insurance/insurance')" class="dropdown">
             <a>保单管理</a>
         </li>
       <!-- 二级菜单:库存 -->
         <li @click="goto('/insurance/bid')" class="dropdown">
            <a>保险标管理</a>
         </li>
       <!-- 二级菜单:Token -->
            <li class="dropdown">
                ...
                <ul class="dropdown-content">
                 <li @click="goto('/insurance/tokenpay')">
                    <a>收支Token</a>
                 </li>
                 <li @click="goto('/insurance/tokenchange')">
                    <a>兑付Token</a>
                 </li>
