<template>
    ...
    <div class="middle" :style="backgroundDiv">
        ...
        <!-- white background -->
         <div id="bkg" style="position: absolute;  margin-top:123px; margin-left:19px; ">
           ...
           <!-- data table -->
                ...
                <td id="x" >{{user.id}}</td>
                <td id="x" >{{user.contractname}}</td>
                <td id="x" >{{user.initiator}}</td>
                <td id="x" >{{user.signtory}}</td>
        ...
        <!-- 底部按钮 -->
           ...
           <input type="button" id="pushbtn"  value="发起合同" onclick="document.getElementById('alert').style.display='block';">
        </div>
        <!-- 发起合同 -->
    <div id="alert" style="position: absolute;margin-top:280px;margin-left:340px;">
         <div class="alert_content">
            ...
            <div>
                ...
                <div id="u1671" class="text" style="position: absolute;margin-top:8px;margin-left:20px;"> 
                    <p id="home1"><span>合同名称：</span></p>
                </div>
            </div>
            <div>
                ...
                <div id="u1671" class="text" style="position: absolute;margin-top:58px;margin-left:36px;"> 
                    <p id="home1"><span>签署方：</span></p>
                </div>
            </div>
            <div>
...
export default {
    ...
    content:'123',
        users: [
                    {"id":1, "contractname":"关于...", "initiator":"xx企业", "signtory":"yy企业","content":"","consigtime":"2019-06-01","condition":"待签署","conditiontime":"2019-06-02"},
                    {"id":1, "contractname":"关于...", "initiator":"xx企业", "signtory":"yy企业","content":"","consigtime":"2019-06-01","condition":"待签署","conditiontime":"2019-06-02"}
                 ]
        }
    },
    components:{ enterprisemenu:enterprisemenu },
    componebts:{ testbutton:testbutton},
        methods:{
    someThing(a){
          console.log(a);
    },
