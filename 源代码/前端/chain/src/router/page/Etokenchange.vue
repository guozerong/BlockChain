    ...
    <div id="alert" style="position: absolute;margin-top:280px;margin-left:340px;">
         <div class="alert_content">
            ...
            <div>
                ...
                <div id="u1671" class="text" style="position: absolute;margin-top:108px;margin-left:36px;"> 
                    <p id="home1"><span>抵押品：</span></p>
                </div>
            </div>
            <div>
...
export default {
    ...
    data(){
        ...
        token:'500Token',
        users: [
                    {"id":1, "acceptor":"xx1银行", "applytime":"2019-06-01","money":"100Token","condition":"待兑付","conditiontime":"2019-06-02"},
                    {"id":2, "acceptor":"xx2银行", "applytime":"2019-06-02","money":"120Token","condition":"已拒绝","conditiontime":"2019-06-03"}
                    ]
        }
    },
